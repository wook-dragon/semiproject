	...
	<div class="" id="mydiv">
		...
		<div class="" id="loginboxdiv">
			<div class="login-box well" id="loginboxinnerbox">
				<form action="LoginOk.jsp" name="loginForm" id="loginForm"
					...
					<div class="form-group" id="formBtn">
						<input type="submit" value="로그인" class="btn btn-skin btn-scroll">
						<input type="reset" value="취소" class="btn btn-skin btn-scroll">
					</div>
				</form>
			</div>
		</div>
