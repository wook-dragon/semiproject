             ...
             <%
               ...
               if(id != null) { //session값 중에 아이디가 있다면
                  ...
                  if(id.equals("admin")){ // 그중에서도 만약 admin이라면
                     ...
                     out.print("<a href='enroll.do' class='btn btn-skin btn-scroll'>사원등록</a>&nbsp;");
                     out.print("<a href='printemplist.do' class='btn btn-skin btn-scroll'>사원검색</a>&nbsp;");
                     out.print("<a href='empchart.do' class='btn btn-skin btn-scroll'>사원차트</a>");
                  }
               }else { 
                  // 로그인 하지 않은 사용자
